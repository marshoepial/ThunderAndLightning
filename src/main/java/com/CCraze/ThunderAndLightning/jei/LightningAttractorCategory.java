...
public class LightningAttractorCategory implements IRecipeCategory<LightningAttractorRecipe> {
    private ResourceLocation guibg = new ResourceLocation("thunderandlightning:textures/gui/lightning_attractor.png");
    ...
    public ResourceLocation getUid() {
        return new ResourceLocation("thunderandlightning", "lightningattractor");
    }
